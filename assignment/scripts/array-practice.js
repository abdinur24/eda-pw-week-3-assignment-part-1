...
let foodArray = ['Pasta', 'Rice', 'Sambusa', 'Doro wat'];
...
foodArray.unshift( 'Lasagna' );
console.log( `Added a favorite food to beginning: ${foodArray}`);
...
foodArray.splice(1, 1,  'Fried Chicken')
console.log( 'Favorite foods are now', foodArray );
...
let foodToJoin = foodArray.join(' and ')
console.log(foodToJoin);
